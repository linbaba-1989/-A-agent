...
def market_resources(qmt_path: str, qmt_port: int, token_configured: bool):
    ...
    realtime_feed = RealtimeMarketFeed(selection.provider, market_scanner) if selection.provider else None
    return router, selection, market_scanner, realtime_feed
...
market_router, market_selection, market_scanner, realtime_feed = market_resources(
